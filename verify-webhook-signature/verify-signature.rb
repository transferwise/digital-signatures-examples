...
public_key = OpenSSL::PKey::RSA.new(sandbox_public_key)
...
is_valid = public_key.verify(OpenSSL::Digest::SHA256.new, decoded_signature_header, webhook_body)

puts "Is signature valid? #{is_valid}"